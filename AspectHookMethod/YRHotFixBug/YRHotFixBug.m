...
#import "YRHotFixBug.h"
#import <JavaScriptCore/JavaScriptCore.h> // 使用JSContext
#import <objc/runtime.h>
#import "Aspects.h"
@implementation YRHotFixBug



+(YRHotFixBug *)shareInstance{
    
    static YRHotFixBug *instance = nil;
...
+ (void)_fixWithMethod:(BOOL)isClassMethod
    ...
    [klass aspect_hookSelector:sel withOptions:option usingBlock:^(id aspectInfo){
        ...
        [fixImpl callWithArguments:@[[aspectInfo instance],
...
+ (void)fixIt
{
    [self context][@"fixInstanceMethodBefore"] = ^(NSString *instanceName,
    ...
    [self context][@"fixInstanceMethodReplace"] = ^(NSString *instanceName,
                                                    NSString *selectorName,
                                                    JSValue *fixImpl) {
    ...
    [self context][@"fixInstanceMethodAfter"] = ^(NSString *instanceName,
                                                  NSString *selectorName,
                                                  JSValue *fixImpl) {
